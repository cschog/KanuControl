...
import RahmendatenAccordion from "@/components/simulation/RahmendatenAccordion";
import { PlanungsSimulation } from "@/api/types/simulation/PlanungsSimulation";

interface Props {
  simulation: PlanungsSimulation;
  onChange: (simulation: PlanungsSimulation) => void;
}
...
export default function SimulationForm({
  ...
  const update = <K extends keyof PlanungsSimulation>(key: K, value: PlanungsSimulation[K]) => {
    const next = {
      ...simulation,
      [key]: value,
    };
    ...
    <Card>
      <CardContent>
        <Grid container spacing={2}>
          {/* Allgemein */}
          <Grid size={12}>
            <RahmendatenAccordion veranstaltung={simulation.veranstaltung} />
          </Grid>
                ...
                <FormControlLabel
                  control={
                    <Switch
                      ...
                      onChange={(e) => update("kikZertifiziert", e.target.checked)}
                    />
                  }
          ...
          <SimulationSection
            ...
            icon={<SellIcon color="primary" fontSize="small" />}
          >
            <Grid size={fieldSize}>
              <SliderNumberField
                ...
                step={1}
                suffix="€"
                onChange={(value) => update("unterkunftPreisProPersonUndNacht", value)}
              />
            </Grid>
            ...
            <Grid size={fieldSize}>
              <SliderNumberField
                ...
                step={0.5}
                suffix="€"
                onChange={(value) => update("verpflegungPreisProPersonUndTag", value)}
              />
            </Grid>
            ...
            <Grid size={fieldSize}>
              <SliderNumberField
                ...
                step={5}
                suffix="€"
                onChange={(value) => update("teilnehmerBeitragUnter21Jahre", value)}
              />
            </Grid>
            ...
            <Grid size={fieldSize}>
              <SliderNumberField
                ...
                step={5}
                suffix="€"
                onChange={(value) => update("mitarbeiterBeitrag", value)}
              />
            </Grid>
          </SimulationSection>
          ...
          <SimulationSection title="Kosten" icon={<PaidIcon color="primary" fontSize="small" />}>
            ...
            <Grid size={fieldSize}>
              <SliderNumberField
                ...
                step={5}
                suffix="€"
                onChange={(value) => update("verbrauchsmaterialProTag", value)}
              />
            </Grid>
            ...
            <Grid size={fieldSize}>
              <SliderNumberField
                ...
                step={25}
                suffix="€"
                onChange={(value) => update("honorare", value)}
              />
            </Grid>
            ...
            <Grid size={fieldSize}>
              <SliderNumberField
                ...
                step={25}
                suffix="€"
                onChange={(value) => update("kultur", value)}
              />
            </Grid>
            ...
            <Grid size={fieldSize}>
              <SliderNumberField
                ...
                step={50}
                suffix="€"
                onChange={(value) => update("miete", value)}
              />
            </Grid>
            ...
            <Grid size={fieldSize}>
              <SliderNumberField
                ...
                step={5}
                suffix="€"
                onChange={(value) => update("sonstigeKostenProTag", value)}
              />
            </Grid>
          </SimulationSection>
        </Grid>
